        ...
        <div class="container">
            <div class="row">
                @forelse ($Categories as $Category)
                    <div class="col-12">
                        <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                            <h1 class="m-0 h5">{{ $Category->name }}</h1>
                            <a class="text-secondary font-weight-medium text-decoration-none" href="{{ route('category', ['slug' => $Category->slug, 'id' => $Category->id]) }}">View
                                All</a>
                        </div>
                    </div>
                    @foreach ($Category->news->sortByDesc('created_at')->take(10) as $news)
                        <div class="col-lg-6">
                            <div class="d-flex mb-3">
                                ...
                                <div class="w-100 d-flex flex-column justify-content-center bg-light px-3"
                                    ...
                                    <div class="mb-1" style="font-size: 13px;">
                                        ...
                                        <span class="text-dark">{{ $news->created_at->format('F d, Y') }}</span>
                                    </div>
                                    <a class="h6 m-0"
