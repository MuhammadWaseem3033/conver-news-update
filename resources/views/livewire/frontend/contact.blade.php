                    ...
                    <div class="bg-light mb-3" style="padding: 30px;">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <p class="m-0">waseemrajpoot3033@gmail.com</p>
                            </div>
                        </div>
                ...
                <div class="col-md-7">
                    <div class="contact-form bg-light mb-3" style="padding: 30px;">
                        ...
                        <form name="sentMessage" id="contactForm" novalidate="novalidate">
                            ...
                            <div>
                                <button class="btn btn font-weight-semi-bold px-4 " style="height: 50px; background-color:#ff6600 ;color:#000 " type="submit" id="sendMessageButton">Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
